...
El objetivo de esta hoja de trabajo era realizar un analisis exploratorio a la base de datos de peliculas, extraido de IMDB. Es base cuenta de datos con `r nrow(datos)` filas y con `r ncol(datos)` de columnas. <br/>
