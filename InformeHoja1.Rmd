---
title: "Informe HDT1"
author: "Marco Ramirez 19588, Alfredo Quezada 191002, Estuardo Hernandez"
date: "04/02/2022"
output:
...
pregunta4.10<-ggplot(data=result, mapping=aes(x=directores, y=calificacion,fill=directores)) + 
  stat_summary(fun.data=mean_sdl, geom="bar") + 
  scale_y_continuous(labels=scales::dollar) + 
