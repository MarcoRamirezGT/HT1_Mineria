...
pregunta4.10<-ggplot(data=result, mapping=aes(x=reorder(directores, -calificacion), y=calificacion,fill=directores)) + 
  stat_summary(fun.data=mean_sdl, geom="bar") + 
  scale_y_continuous(labels=scales::dollar) + 
...
pregunta4.13<-ggplot(data=result, mapping=aes(x=reorder(ingresos, mes), y=ingresos,fill=mes)) + 
  stat_summary(fun.data=mean_sdl, geom="bar") + 
  scale_y_continuous(labels=scales::dollar) + 
